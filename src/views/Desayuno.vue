...
<template>
  <div>
    <div class="hero">
      <h1>Menú de Desayuno</h1>
      <p class="tagline">Empieza el día con algo casero.</p>
    </div>

    <div class="tarjetas-categoria">
      <div
        v-for="categoria in desayuno"
