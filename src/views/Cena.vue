...
<template>
  <div>
    <div class="hero">
      <h1>Menú de Cena</h1>
      <p class="tagline">Cuando cae la noche, se sirve lo bueno.</p>
    </div>

    <div class="tarjetas-categoria">
      <div
        v-for="categoria in cena"
